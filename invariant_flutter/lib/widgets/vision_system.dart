...
class VisionSystem extends StatefulWidget {
  const VisionSystem({super.key});

  @override
  State<VisionSystem> createState() => _VisionSystemState();
}

class _VisionSystemState extends State<VisionSystem>
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: 50,
            left: 80,
            child: _buildSimulatedObject('PERSON', const Color(0xFF00FF88)),
          ),
          Positioned(
            top: 120,
            right: 100,
            child: _buildSimulatedObject('VEHICLE', const Color(0xFFFFD93D)),
          ),
          Positioned(
            bottom: 80,
            left: 120,
    ...
    return Stack(
      children: [
        ...
        Positioned(
          top: 45,
          left: 75,
          child: _buildDetectionBox(const Color(0xFF00FF88)),
        ),
        // Detection box 2
        Positioned(
          top: 115,
          right: 95,
          child: _buildDetectionBox(const Color(0xFFFFD93D)),
        ),
        // Detection box 3
        Positioned(
          bottom: 75,
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(
                color: const Color(0xFF00D4FF).withOpacity(0.8 + _pulseController.value * 0.2),
                width: 2,
              ),
  ...
  Widget _buildVisionControls() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        _buildControlButton('ZOOM', Icons.zoom_in, const Color(0xFF00D4FF)),
        const SizedBox(width: 20),
        _buildControlButton('TRACK', Icons.gps_fixed, const Color(0xFF00FF88)),
        const SizedBox(width: 20),
        _buildControlButton('RECORD', Icons.videocam, const Color(0xFFFF6B6B)),
        const SizedBox(width: 20),
        _buildControlButton('ANALYZE', Icons.analytics, const Color(0xFFFFD93D)),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildStatusItem('CAMERA', 'ACTIVE', const Color(0xFF00FF88)),
          _buildStatusItem('DETECTION', '3 OBJECTS', const Color(0xFFFFD93D)),
          _buildStatusItem('TRACKING', 'ENABLED', const Color(0xFF00FF88)),
        ],
      ),
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 5),
            _buildDetectionItem('PERSON', const Color(0xFF00FF88)),
            _buildDetectionItem('VEHICLE', const Color(0xFFFFD93D)),
